   ...
   <form className="bg-gradient-to-b from-green-400 p-6">
      ...
      <div className="grid grid-cols-12 rounded-xl bg-white place-items-end items-center gap-4 p-12 m-12 drop-shadow-xl">
        ...
        <input
          ...
          required
        />
        <button className="w-full col-span-6 bg-green-400 text-white py-4 rounded-md font-bold shadow-inner
          hover:shadow-green-400 hover:bg-white hover:text-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400"n>
        <Link
